...
- Figures/tables placed here:
  - Table III: pre-onset negative control, all four cells plus family pooling. Supports N1. This table is non-negotiable; the failed control is reported as a table, not as a sentence in a limitations list.
